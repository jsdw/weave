...
```
curl -L https://github.com/jsdw/weave/releases/download/v0.3.1/weave-v0.3.1-x86_64-apple-darwin.tar.gz | tar -xz
```

For **Linux**, run:

```
curl -L https://github.com/jsdw/weave/releases/download/v0.3.1/weave-v0.3.1-x86_64-unknown-linux-musl.tar.gz | tar -xz
```
