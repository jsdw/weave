...
```
curl -L https://github.com/jsdw/weave/releases/download/v0.3.2/weave-v0.3.2-x86_64-apple-darwin.tar.gz | tar -xz
```

For **Linux**, run:

```
curl -L https://github.com/jsdw/weave/releases/download/v0.3.2/weave-v0.3.2-x86_64-unknown-linux-musl.tar.gz | tar -xz
```
...
Finally, to install a release of `weave` (here, v0.3.2), run the following:

```
cargo install --git https://github.com/jsdw/weave.git --tag v0.3.2 --force
```
